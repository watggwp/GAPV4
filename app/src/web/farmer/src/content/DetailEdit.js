    ...
    const SelectHead = async (id_table_edit, e) => {
        ...
        if (await CloseAccount(result, setPage)) {
            ...
            if (e) {
                ...
                if (selectedElement) selectedElement.removeAttribute("select");
                e.target.setAttribute("select", "");
            }
            if (Data && Data.head && Data.head.id_edit) {
                setHead(Data.head);
                setBody(Data.detail || []); // ใช้ [] แทน null หรือ undefined
                setLoad(true);
            } else {
                console.error("Data.head is undefined or missing id_edit");
                setLoad(true);
            }
        }
    };
        ...
        <section id="detail-edit-popup">
            {Data[0] ? (
                    ...
                    {LoadingData ? (
                        <div className="body-edit">
                            <div className="head-detail-edit">
                                ...
                                {HeadEdit.fullname_doctor && (
                                    <div className="row-detail">
                                        <span>แก้ไขโดย</span>
                                        <span className="dot">:</span>
                                        <div>{HeadEdit.fullname_doctor}</div>
                                    </div>
                                )}
                                <div className="line"></div>
                                <div className="row-detail column">
                ...
                <>
                    ...
                    <div className="not-edit">ไม่พบการแก้ไขข้อมูล</div>
                </>
            )}
        </section>
    );
