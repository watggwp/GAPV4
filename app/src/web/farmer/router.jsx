          ...
          <Route path="form" element={<GreenhouseIndex />}>
            <Route path=":greenhouse_id" element={<Greenhouse />}>
              ...
              <Route
                ...
                element={
                  <GreenhouseWrapper
                    element={<InformationReport />}
                    namepage={"gap-information"}
                  />
                }
              />
              ...
              <Route
                ...
                element={
                  <GreenhouseWrapper
                    element={<ListFactor type_path_factor={"z"} />}
                    namepage={"gap-greenhouse-fertilizer"}
                  />
                }
              />
              <Route
                ...
                element={
                  <GreenhouseWrapper
                    element={<ListFactor type_path_factor={"c"} />}
                    namepage={"gap-greenhouse-chemical"}
                  />
                }
              />
              <Route
                ...
                element={
                  <GreenhouseWrapper
                    element={<DataForm />}
                    namepage={"gap-greenhouse-dataform"}
                  />
                }
              />
              ...
              <Route
                ...
                element={
                  <GreenhouseWrapper
                    element={<Success type_page={"h"} />}
                    namepage={"gap-greenhouse-success-h"}
                  />
                }
              />
              <Route
                ...
                element={
                  <GreenhouseWrapper
                    element={<Success type_page={"cf"} />}
                    namepage={"gap-greenhouse-success-cf"}
                  />
                }
              />
              <Route
                ...
                element={
                  <GreenhouseWrapper
                    element={<Success type_page={"cp"} />}
                    namepage={"gap-greenhouse-success-cp"}
                  />
                }
              />
              ...
              <Route
                ...
                element={
                  <GreenhouseWrapper
                    element={<PumpControlPage />}
                    namepage={"gap-greenhouse-pump"}
                  />
                }
              />
              ...
              <Route
                ...
                element={
                  <GreenhouseWrapper
                    element={<Sensor />}
                    namepage={"gap-greenhouse-sensor"}
                  />
                }
              />
              <Route
                path=":gap_id/sensor/:device_id"
                element={
                  <GreenhouseWrapper
                    element={<SensorGreenhouse />}
                    namepage={"gap-greenhouse-sensor-device"}
                  />
                }
              />
