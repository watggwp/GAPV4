...
export default class List extends Component {
    ...
    LoadDetailInput = () => {
        document.querySelectorAll('.admin-detail .indetail .text-detail').forEach((ele)=>{
    ...
    componentDidMount(){
        ...
        resizeObserver.observe(document.getElementById('body-list-admin'))
            ...
            body : JSON.parse(this.props.list).map((listDT , index) =>
                        <div key={index} className="container-doctor" id={`list-${index}`}>
                            ...
                            <div className="bt-manage">
                                <span className="box-status" onClick={() => this.changeStatus(listDT['id'] , `status-${index}`)}>
                                ...
                                <button className="bt-delete" onClick={() => this.deleteAC(listDT['id'] , index)}>ลบบัญชี</button>
                            </div>
                        </div>
    ...
    render() {
        return (
            <section id="body-list-admin">
                <div id="popup-delete">
                    {this.state.delete}
                </div>
                <div id="popup-detail-admin">
...
class ShowDetail extends Component {
    ...
    removePopup = (e) => {
        document.getElementById('popup-detail-admin').removeAttribute('show')
