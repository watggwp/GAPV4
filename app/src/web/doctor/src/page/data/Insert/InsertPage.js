      ...
      <div className="row">
        ...
        <label className="field-select">
          ...
          <input
            ...
            onChange={CheckInsert}
            onKeyDown={(e) => InputKeyDownNext(e, typeInsert.current)}
            placeholder="เช่น เมล่อนแสนหวาน"
          ></input>
        </label>
      ...
      <div className="row">
        <label className="field-select">
          ...
          <div className="box-input-number">
            <input
              ref={formulaFertilizer[0]}
              onKeyDown={(e) =>
                InputKeyDownNext(e, formulaFertilizer[1].current)
              }
              onChange={CheckInsert}
              placeholder="ตัวเลข"
              onInput={(e) => setMaxText(e, 2, "INPUT")}
              type="number"
            ></input>
            <span>-</span>
            <input
              ref={formulaFertilizer[1]}
              onKeyDown={(e) =>
                InputKeyDownNext(
                  e,
                  formulaFertilizer[2].current,
                  formulaFertilizer[0].current
                )
              }
              onChange={CheckInsert}
              placeholder="ตัวเลข"
            ...
            <span>-</span>
            <input
              ref={formulaFertilizer[2]}
              onKeyDown={(e) =>
                InputKeyDownNext(
                  e,
                  UseText.current,
                  formulaFertilizer[1].current
                )
              }
              onChange={CheckInsert}
              placeholder="ตัวเลข"
      ...
      <div className="row">
        <label className="field-select">
          ...
          <input
            ref={formulaChemical}
            onChange={CheckInsert}
            onKeyDown={(e) => InputKeyDownNext(e, UseText.current)}
      ...
      <div className="row">
        <label className="field-select not1">
          ...
          <input
            ref={UseText}
            onChange={CheckInsert}
            onKeyDown={(e) => InputKeyDownNext(e, DateQtyInsert.current)}
            placeholder="เช่น ฉีดพ้น"
          ></input>
        </label>
        <label className="field-select not1">
      ...
      <div className="row">
        <label className="field-select">
          ...
          <input
            ...
            placeholder="เช่น สหกรณ์แม่เตียน"
          ></input>
        </label>
      </div>
      <div className="row">
        <label className="field-select">
          ...
          <input
            ref={InputUrl}
            placeholder="url/แชร์จาก google map"
            onInput={GenerateMap}
            type="search"
          ></input>
        </label>
